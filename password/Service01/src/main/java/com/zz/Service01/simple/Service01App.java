...
public class Service01App {
	...
	public String test(@RequestHeader(name = "Authorization") String token) {
		...
		System.err.println("service01 controller.. token:" + token);
		...
		ResponseEntity<String> response = restTemplate.exchange("http://localhost:8082/users/hello", HttpMethod.GET, entity,
				String.class);
